import {
  ...
  const itineraryReducer = (state = initialState, action) => {
    switch (action.type) {
      ...
      case FAVORITE_ITINERARY_REQUEST:
        return {
          ...state,
          loading: true,
          error: null
      ...
      case DELETE_ITINERARY_SUCCESS:
        return {
          ...
          currentItinerary: state.currentItinerary?.id === action.payload ? null : state.currentItinerary,
          loading: false,
          error: null
        };
      ...
      case FAVORITE_ITINERARY_SUCCESS:
        return {
          ...
          currentItinerary: state.currentItinerary?.id === action.payload.id ? 
            action.payload : state.currentItinerary,
          loading: false,
          error: null
        };
      ...
      case FAVORITE_ITINERARY_FAILURE:
        return {
          ...state,
          loading: false,
